        ...
        <div className="header-content row">
          <div className="col-xs-12 col-sm-5 col-md-5">
            ...
            <div
              ...
              data-wow-delay="1s"
            >
              <i className="hbtn" /> <span>Free Download</span>{" "}
    ...
    <section id="about" className="">
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          >
            <h1>
              <span>HEY THERE!</span> WELCOME TO OUR SITE
            </h1>
          </div>
          <div
          ...
          >
            ...
            <p>
              ...
              voluptatem sequi nesciunt.Contrary to popular belief, Lorem Ipsum is
      ...
      <div className="container">
        <div className="row">
          <div className="col-xs-12 col-sm-12 col-md-12">
            ...
            <p className="copyright">© 2016 Canvas</p>
          </div>
        </div>
      </div>
      {/* =============== container end =============== */}
